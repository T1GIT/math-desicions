...
class Task3(AbstractTask):
    ...
    def chart(self):
        ...
        go.Figure(data=[
            ...
            go.Scatter3d(name="Оптимальная точка", x=[self.u_point[0]], y=[self.u_point[1]], z=[self.u_value], marker=dict(color='white')),
        ...
        go.Figure(data=[
            ...
            go.Scatter(name="Оптимальная точка", x=[self.u_point[0]], y=[self.u_point[1]], marker=dict(color='white')),
